...
**Component diagrams** show the dependencies between the logical and physical components of a system with the [interfaces that each component requires and provides](/blog/component-diagrams.html) and their ports.
