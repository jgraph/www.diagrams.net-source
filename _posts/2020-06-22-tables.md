...
<img src="/assets/img/blog/arrange-table-tools.png" width="150" alt="Use the table tools in the Arrange tab in the format panel to insert and delete columns and rows">
