...
You can also merge cells, and unmerge merged table cells via the _Arrange_ tab in the format panel, or using the _Table_ tool in the Sketch whiteboard-like editor theme. 
...
<br /><img src="/assets/img/blog/arrange-tab-unmerge.png" style="width=100%;max-width:400px;height:auto;" alt="Unmerge table cells in the diagrams.net and draw.io editor via the Arrange tab in the format panel">