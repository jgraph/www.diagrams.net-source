...
The following layouts are available. The parameters are in the _Variables_ section of the respective pages:
...
[Build a diagram quickly by inserting a layout](/doc/faq/insert-layouts.html)
